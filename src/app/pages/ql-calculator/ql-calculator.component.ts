...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [ReactiveFormsModule, NgIf, NgForOf, QlNumberComponent],
  templateUrl: './ql-calculator.component.html',
  styleUrl: './ql-calculator.component.css'
})
export class QlCalculatorComponent implements OnInit {
